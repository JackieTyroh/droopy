...
class _ResetPState extends State<ResetP> with SingleTickerProviderStateMixin{
            ...
            Center(
                    child: Column(
                     ...
                     children: <Widget>[
                              ...
                              Text('Enter your email address below.You will receive a link on your email to reset your password',
                              ...
                              height: 55.0,
                              color: Colors.blue,
                              child: Text('Reset Password',style: TextStyle(fontSize: 30,color: Colors.white),),
                              onPressed: (){},
                            ),
